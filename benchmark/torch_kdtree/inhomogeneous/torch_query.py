...
mean = np.array(means)
std = np.array(stds)
np.savetxt("../../inhomo_torch_knn_times.txt", np.vstack((karray, means, stds)).T, header="k mean_time(s) stddev(s)")
...
np.savetxt("../../inhomo_torch_ball_times.txt", np.vstack((rad_array, means, stds)).T, header="radius mean_time(s) stddev(s)")
